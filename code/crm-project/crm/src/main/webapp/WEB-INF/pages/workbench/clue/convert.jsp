...
<script type="text/javascript">
	$(function(){
		...
		$("#searchActivityTxt").keyup(function () {
			...
			// 发送请求
			$.ajax({
				url:'workbench/clue/queryActivityForConverByNameClueId.do',
				data:{
		...
		//给“转换”按钮添加单击事件
		$("#saceConvertClueBtn").click(function (){
			//收集参数
			var clueId = '${clue.id}';
...
<body>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form>
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control my-date" id="expectedClosingDate">
		  </div>
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activityName">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" data-toggle="modal" id="searchActivityBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
	...
	<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
		<input class="btn btn-primary" type="button" id="saceConvertClueBtn" value="转换">
		&nbsp;&nbsp;&nbsp;&nbsp;
