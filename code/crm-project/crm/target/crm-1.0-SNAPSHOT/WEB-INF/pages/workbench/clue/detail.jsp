...
<script type="text/javascript">
	...
	$(function(){
		...
		//给"保存"按钮添加单击事件
		$("#saveCreateClueReamrkBtn").click(function () {
			//收集参数
			...
			$.ajax({
				...
				success:function (data) {
					if(data.code == "1"){
						...
						//刷新备注列表
						var htmlStr = "";
						htmlStr += "<div class=\"remarkDiv\" id=\"div_${remark.id}\" style=\"height: 60px;\">";
		...
		$("#remarkDivList").on("click","a[name='deleteA']",function () {
			...
			//发送请求
			$.ajax({
				url:'workbench/clue/deleteActivityRemarkById.do',
				data:{
					id:id
				},
				type:'post',
		...
		$("#searchActivityTxt").keyup(function () {
			...
			// 发送请求
			$.ajax({
				url:'workbench/clue/queryActivityFoeDetailByNameClueId.do',
				data:{
		...
		<div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
			<form role="form" style="position: relative;top: 10px; left: 10px;">
				...
				<p id="cancelAndSaveBtn" style="position: relative;left: 737px; top: 10px; display: none;">
					...
					<button type="button" class="btn btn-primary" id="saveCreateClueReamrkBtn">保存</button>
				</p>
			</form>
		</div>
	</div>
